  ...
  const StatCard = ({
    ...
    <div
      style={{
        ...
        borderRadius: 6,
        padding: "14px 16px",
        background: highlight ? "#F3F4F6" : "#FAFAFA",
      }}
    >
      <div
        style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Fatima K Design · Bride Portal
        </span>
        <span style={{ color: "#6B7280", marginLeft: "auto" }}>
          Wireframe for Client Approval · v1.0
        </span>
        ...
        <div style={{ flex: 1, padding: "20px 24px", overflowY: "auto" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                >
                  Your wedding is in 47 days
                </div>
                <div style={{ fontSize: 10, color: "#9CA3AF" }}>
                  4th May 2026 — Countdown banner
                </div>
              </div>
            </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ fontSize: 11, color: "#9CA3AF" }}>
              H1 Heading · Cormorant Garamond · subheading text below
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
            <StatCard
              ...
              value="Tue 24 Mar · 2:00 PM"
              sub="Final Fitting · Paddington Studio"
            />
            <div
              style={{
                flex: 1,
          ...
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            ...
            >
              ...
              <AppointmentRow
                ...
                time="2:00 PM"
                type="Final Fitting"
                note="What to bring: shoes, veil, undergarments"
              />
              <AppointmentRow
                date="4 May"
                time="10:00 AM"
                type="Dress Pickup"
                note="What to bring: garment bag, ID"
              />
              <div
                style={{
                  border: "1.5px dashed #D1D5DB",
              ...
              >
                <span style={{ fontSize: 10, color: "#9CA3AF" }}>
                  + Add / Request Appointment (optional CTA)
                </span>
              </div>
            </div>
              ...
              >
                {["Photo 1", "Photo 2", "Photo 3", "Photo 4"].map((p) => (
                  <div key={p}>
                    ...
                    />
                    <div
                      style={{ fontSize: 9, color: "#9CA3AF", marginTop: 3 }}
                    >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 10 }}>
              {["Lace ref", "Neckline", "Veil style", "Train length"].map(
                (label) => (
                  <div key={label} style={{ flex: 1 }}>
                    <WireBox
                      label={label}
                      crosshatch
                      style={{ height: 90, width: "100%" } as any}
                    />
                    <div
                      style={{
                        fontSize: 9,
          ...
          >
            ...
            <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
              {[
                ...
                <div key={s} style={{ fontSize: 10, color: "#9CA3AF" }}>
                  — {s}
                </div>
              ))}
            </div>
