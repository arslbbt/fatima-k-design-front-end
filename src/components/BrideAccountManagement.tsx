...
import { bridesApi, authApi, ApiError } from "@/lib/api";
...
export function BrideAccountManagement() {
  ...
  useEffect(() => {
    ...
    setName(me.name);
    setEmail(me.email);
    setPhone(me.brideProfile?.phone ?? "");
  }, [me]);
  ...
  const weddingDate = me?.brideProfile?.weddingDate
    ? new Date(me.brideProfile.weddingDate).toLocaleDateString("en-AU", {
        day: "numeric",
        month: "long",
        year: "numeric",
      })
              ...
              {tab === "security" && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      Once you delete your account, all your data is permanently
                      removed. Please contact the studio before proceeding.
                    </p>
                    <button
                      style={{
                        padding: "9px 18px",
